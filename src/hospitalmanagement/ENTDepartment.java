...
public class ENTDepartment extends javax.swing.JFrame {
...
ps = con.prepareStatement("select DOCTORNAME  ,SPECIALIZATION , GENDER, CONTACTNO , EXPERIENCE,  AGE , DESIGNATION from doctorprofile  where doctorid='12' ");
...
JOptionPane.showMessageDialog(null, ex.getMessage()+" error");        }}
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ENT Specialist :");
        ...
        jLabel5.setText("ENT Department");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ENTDepartment().setVisible(true);
            }
        });
    }
